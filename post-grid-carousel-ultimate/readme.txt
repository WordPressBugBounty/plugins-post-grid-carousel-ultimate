...
= 1.8.1 =
* Fix: Stored XSS in the shortcode settings metabox (Header Title, Total Posts, Image Width fields were not escaped on output) - reported by Yaswanth Reddy Sunkara via WPScan/Jetpack
= 1.8 =
